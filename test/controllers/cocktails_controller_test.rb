...
class CocktailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cocktail" do
    assert_difference("Cocktail.count") do
      post cocktails_url, params: { cocktail: { build: @cocktail.build, ingredients: @cocktail.ingredients, likes: @cocktail.likes, name: @cocktail.name, type: @cocktail.type, user_id: @cocktail.user_id } }
    end
  ...
  test "should update cocktail" do
    patch cocktail_url(@cocktail), params: { cocktail: { build: @cocktail.build, ingredients: @cocktail.ingredients, likes: @cocktail.likes, name: @cocktail.name, type: @cocktail.type, user_id: @cocktail.user_id } }
